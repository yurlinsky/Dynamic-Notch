...
extension Defaults.Keys {
    static let selectedLanguage = Key<String>("selectedLanguage", default: "en")
}
...
struct GeneralSettings: View {
    ...
    @Default(.selectedLanguage) var selectedLanguage
    ...
    var body: some View {
        Form {
            ...
            Section {
                Defaults.Toggle(NSLocalizedString("menubar_icon", comment: ""), key: .menubarIcon)
    ...
    func NotchBehaviour() -> some View {
        Section {
            Defaults.Toggle(NSLocalizedString("enable_haptics", comment: ""), key: .enableHaptics)
...
struct Charge: View {
    var body: some View {
        Form {
            Section {
                Defaults.Toggle(NSLocalizedString("Show charging indicator", comment: ""), key: .chargingInfoAllowed)
                Defaults.Toggle(NSLocalizedString("Show battery indicator", comment: ""), key: .showBattery)
            } header: {
                Text(NSLocalizedString("general", comment: ""))
            }
        }
        .tint(Defaults[.accentColor])
        .navigationTitle(NSLocalizedString("battery", comment: ""))
    }
}
...
struct Downloads: View {
    ...
    var body: some View {
        Form {
            ...
            Section {
                Defaults.Toggle(NSLocalizedString("show_download_progress", comment: ""), key:
                ...
                Picker("Download icon style", selection: $selectedDownloadIconStyle) {
                    Text("Only app icon").tag(DownloadIconStyle.onlyAppIcon)
                    Text("Only download icon").tag(DownloadIconStyle.onlyIcon)
    ...
    var body: some View {
        Form {
            ...
            Picker(selection: $hideNotchOption, label:
                HStack {
                    Text("Hide DynamicNotch Options")
                    customBadge(text: "Beta")
                }) {
...
struct Appearance: View {
    ...
    var body: some View {
        Form {
            ...
            Section {
                Defaults.Toggle(String(localized: "coloredSpectrogram"), key: .coloredSpectrogram)
                Defaults
            ...
            Section {
                Defaults.Toggle(NSLocalizedString("Enable boring mirror", comment: ""), key: .showMirror)
                    .disabled(!checkVideoInput())
                
                Picker(NSLocalizedString("Mirror shape", comment: ""), selection: $mirrorShape) {
                    Text(NSLocalizedString("Circle", comment: ""))
                        .tag(MirrorShapeEnum.circle)
                    Text(NSLocalizedString("Square", comment: ""))
                        .tag(MirrorShapeEnum.rectangle)
                }
                
                Defaults.Toggle(NSLocalizedString("Show cool face animation while inactivity", comment: ""), key: .showNotHumanFace)
            } header: {
                HStack {
                    Text(NSLocalizedString("Additional features", comment: ""))
                }
            }
